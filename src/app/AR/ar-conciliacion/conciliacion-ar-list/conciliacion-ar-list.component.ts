...
@Component({
  selector: 'app-conciliacion-ar-list',
  templateUrl: './conciliacion-ar-list.component.html',
  styleUrls: ['./conciliacion-ar-list.component.scss']
})
export class ConciliacionARListComponent implements OnInit {
  ...
  generalDetails(id: number){
    this.router.navigate(['conciliacion-ar-details', id]);
  }

  updateGeneral(id: number){
    this.router.navigate(['update-conciliacion-ar', id]);
  }
