...
export class ReportsService {
  ...
  getReportsPeople(datestart1: Date, dateend1: Date): Observable<any> {
    //let uri = (API_URL + 'AC_GET_ALL_REPOR_ADMIT_PEOPL/1.0/getallAdmitted?datestart='+datestart1+'&dateend='+dateend1);
    return this.http.get(`${this.baseUrl}ic/api/integration/v1/flows/rest/AC_GET_ALL_REPOR_ADMIT_PEOPL/1.0/getallAdmitted?datestart=${datestart1}&dateend=${dateend1}`, this.httpOptions);
  }
